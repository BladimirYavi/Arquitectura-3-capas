...
public class Pcuota extends javax.swing.JFrame {
    ...
    void mostrarComboPago(){
        try {
            cbPago.setModel(Negociopago.obtenerPago());
        } catch (Exception e) {
    ...
    void Mostrar(){
        try {
            tablaCuota.setModel(Negociocuota.Mostrar());
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registro de Cuotas");

        jPanel1.setBackground(new java.awt.Color(204, 255, 255));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Registro de Cuotas"));

        jLabel3.setText("IdPago");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(cbPago, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jLabel8)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txtCuota, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                    .addComponent(jLabel2)
                                    .addGap(18, 18, 18)
                                    .addComponent(txtSaldoPago))
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
    ...
    private void cbPagoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbPagoItemStateChanged
        int idPago = Integer.parseInt(cbPago.getSelectedItem().toString());
        txtSaldoPago.setText(Negociopago.obtenerSaldoPago(idPago).toString());
        
    }//GEN-LAST:event_cbPagoItemStateChanged

    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        // TODO add your handling code here:
        idPago = Integer.parseInt(cbPago.getSelectedItem().toString());
        fechaCuota = txtFecha.getText();
        monto = Double.parseDouble(txtCuota.getText());
        Negociocuota.Guardar(monto, fechaCuota, idPago);
        Mostrar();
        limpiar();
        inhabilitar();
